...
| 6 | **Ingestion pipeline** — automated, e.g. **dlt** | 2 | ✅ done | Real dlt source/resources, ELT into the canonical schema for both stores; `just seed` (Postgres) + `just seed-sqlite` (`python -m apps.ingest.sqlite_pipeline`, exit 1 on an empty seed); 18/627/9119/9119 |
...
| 11 | **Bonus: cloud deployment** | 2 | ✅ done | Live at https://homelib.streamlit.app/ — see `docs/evidence.md` (2026-09-08 Cloud demo row) |
